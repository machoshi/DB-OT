...
def config():
    ...
    parser.add_argument('--long_tail', type=int, default=0, 
                        help='0 is a uniform test set, 1 is long tail test, 2 is inverse long tail test')
...
def main(args):
    ...
    if not test_mode:
        ...
        data = {x: dataloader.load_data(data_root=data_root[dataset.rstrip('_LT')],
                                        dataset=dataset, phase=split2phase(x, args),
        ...
        training_model.eval_sinkhorn(phase=test_split, openset=test_open, save_feat=saveit)
        ...
        # print("network")
        # print("///////////////////////////////////")
        # print(training_model.networks['classifier'].state_dict()['module.W.weight'].shape)
        # print(data)
        # print(data['test'])
